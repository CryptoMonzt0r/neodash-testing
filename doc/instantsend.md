...
This mechanism has been integrated into Bitcore-Node-Neodash which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/neodashpay/insight-api-neodash#web-socket-api](https://github.com/neodashpay/insight-api-neodash#web-socket-api)
* API: [https://github.com/neodashpay/insight-api-neodash#instantsend-transactions](https://github.com/neodashpay/insight-api-neodash#instantsend-transactions)
...
By default, the Neodash Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Neodash Core daemon:
