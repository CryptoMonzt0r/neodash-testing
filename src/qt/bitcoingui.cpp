...
void BitcoinGUI::createActions()
{
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Neodash Core"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Neodash Core help message to get a list with possible Neodash Core command-line options"));
