...
All the Neodash in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NDASH, 0.1 NDASH, 1 NDASH and 10 NDASH -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://neodashpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://neodashpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
